...
function welcomeEmailHtml(lang: Lang): string {
  ...
  return `<!DOCTYPE html><html><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1.0"></head><body style="margin:0;padding:0;background:#f4f5f7;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,sans-serif;"><table width="100%" cellpadding="0" cellspacing="0" style="background:#f4f5f7;padding:40px 20px;"><tr><td align="center"><table width="600" cellpadding="0" cellspacing="0" style="background:#fff;border-radius:8px;overflow:hidden;box-shadow:0 1px 3px rgba(0,0,0,.1);"><tr><td style="background:linear-gradient(135deg,#0F1F3D,#1a3a6b);padding:32px 40px;text-align:center;"><span style="color:#fff;font-size:24px;font-weight:700;">Euro<span style="color:#2563EB;">Salary</span></span></td></tr><tr><td style="padding:40px;"><h1 style="color:#0F1F3D;font-size:22px;margin:0 0 20px;">${c.heading}</h1><p style="color:#4a5568;font-size:15px;line-height:1.7;margin:0 0 28px;">${c.body}</p><table cellpadding="0" cellspacing="0" style="margin:0 auto;"><tr><td style="background:#2563EB;border-radius:6px;padding:14px 32px;"><a href="${c.ctaUrl}" style="color:#fff;text-decoration:none;font-weight:600;font-size:15px;">${c.cta}</a></td></tr></table></td></tr><tr><td style="padding:24px 40px;background:#f8fafc;border-top:1px solid #e2e8f0;"><p style="color:#94a3b8;font-size:12px;margin:0;text-align:center;">${c.footer}</p></td></tr></table></td></tr></table></body></html>`;
}
